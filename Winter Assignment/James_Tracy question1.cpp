...
int main() {
	...
	cout << "Welcome to the PAU CBT platform for GST 101." << endl;
	cout << "Press 'A' to proceed or 'X' to exit the application." << endl;
	
	cout << "\n\nEnter an option: ";
	cin >> input;
	input = toupper(input); //'toupper' automatically makes any input capital letter.
	
	if (input == 'A') {
		cout << "\n\nGood. \nLet's proceed to authentication. \n\n" << endl;
		cout << "Please input your username and password '@1234PAU' below. Thank you. \n" << endl; //The username is 'tjames'. 
		...
		cin >> password;
			...
			if (user == "tjames" && password == "@1234PAU") {
				cout << "\n\nWelcome, " << user <<"! \nLet us proceed to the quiz.\n\n" << endl;
				cout << "Welcome to the GST 101 multiple choice quiz. \nYou have twenty minutes to proceed with all ten questions." << endl;
			}
			else {
