...
int main() {
	...
	//cout << "Welcome to the Pan-Atlantic University Computer Based Testing Platform." << endl;
	//cout << "Today you'll be writing your first continuous assessment for General Studies 1 (GST 101)." << endl;
